...
- [ ] **Step 1: Reproduce the missing runtime failure**
...
- [ ] **Step 3: Verify the real suites execute**
...
- [ ] **Step 4: Apply it to web authentication**
...
- [ ] **Step 5: Apply it to mobile persistence**
...
- [ ] **Step 6: Verify cache behavior and clients**
...
- [ ] **Step 1: Write endpoint tests for fabricated and exact evidence**
...
- [ ] **Step 3: Implement request-aware validation**
...
- [ ] **Step 1: Extend the Supabase test double**
...
- [ ] **Step 2: Add multi-page behavior tests**
...
- [ ] **Step 4: Implement complete stable pagination**
...
- [ ] **Step 1: Give every migration a unique version**
...
- [ ] **Step 2: Write failing shared-API tests**
...
- [ ] **Step 5: Replace client database sequences**
...
- [ ] **Step 6: Generate one ID per mutation attempt**
...
- [ ] **Step 1: Rewrite scoring expectations first**
...
- [ ] **Step 3: Implement honest scoring**
...
- [ ] **Step 4: Persist an optional grade**
...
- [ ] **Step 5: Update readiness mapping and copy**
...
- [ ] **Step 2: Run the full frontend/core gate**
...
- [ ] **Step 5: Record results and commit documentation**
...
- [ ] **Step 6: Review repository state before push**
